...
public class CourseController {
    ...
    public Course viewJson(@RequestParam("courseId") Integer courseId) {
    ...
    public String doUploadFile(@RequestParam("file") MultipartFile file) throws IOException {
        ...
        if(!file.isEmpty()){
            ...
            FileUtils.copyInputStreamToFile(file.getInputStream(), new File("/Users/zwb/upload_files/", System.currentTimeMillis()+ file.getOriginalFilename()));
        }
